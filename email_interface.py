...
class MailBox:
    ...
    def __init__(self, master):
        self.master = master
        master.title("Mailbox")
        
        self.subject_label = Label(master, text="Subject:", font="Helvetica 10 bold")
        self.inbox_label = Label(master, text="Inbox", font="Helvetica 12 bold")
        self.to_label = Label(master, text="To:", font="Helvetica 10 bold")
        self.user_label = Label(master, text="Gmail Id:", font="Helvetica 10 bold")
        self.pswd_label = Label(master, text="Password:", font="Helvetica 10 bold")

        self.to_entry = Entry(master, font="Helvetica 10")
        self.sub_entry = Entry(master, font="Helvetica 10")
        self.user_entry = Entry(master, font="Helvetica 10")
        self.pswd_entry = Entry(master, show = "*")
        self.mail_text = Text(master, highlightbackground="black", font="Helvetica 10")
        self.inbox_text = Text(master, highlightbackground="black", font="Helvetica 10")
        ...
        self.view_button = Button(master, text="Show mails", command=self.read_email_from_gmail, highlightbackground="black", bg = "DodgerBlue4", font = custom_font)
        self.refresh_button = Button(master, text="Refresh", command=self.refresh, highlightbackground="black", bg = "DodgerBlue4", font = custom_font)
        self.send_button = Button(master, text="Send", command=self.send_email_to_gmail, highlightbackground="black", bg = "DodgerBlue4", font = custom_font)
